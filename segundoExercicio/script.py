...
def lerDadosRepres():
    ...
    try:
        conexao.commit()
        print("Dados dos representantes gravados no banco")
...
def lerDadosProdutos():
    ...
    try:
        conexao.commit()
        print("Dados dos produtos gravados no banco")
    except Exception as e:
        print(f"Erro: {e}")
...
def lerDadosFornClien():
    ...
    try:
        conexao.commit()
        print("Dados do fornecimento gravados no banco")
    except Exception as e:
        print(f"Erro: {e}")
...
"""
    ...
    try:
        conexao.commit()
        print("Dados dos pedidos gravados no banco")
    except Exception as e:
        print(f"Erro: {e}")
